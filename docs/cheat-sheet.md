# 🖨️ Print & Go — One-Page Deal Cheat Sheet

The entire guide condensed into **one page you can screenshot** or print for the flight. Save this to your phone lock screen.

> **Trip: Oct 31 – Nov 22, 2026 (Sat → Sun) | US Citizens | No ARC | Zero ID check (except alcohol & tax refunds)**
> **Last verified: 2026-08-03**

---

## 📲 Do These BEFORE You Fly (10 minutes total)
...
## 🍔 The Big Hitters (No App, No ID, Just Walk In)
...
| **Mega / Compose / Paik's / The Venti coffee** — 24oz iced Americano | **₩1,500–2,000** | Any branch, kiosk in English |
| **Convenience store 1+1 / 2+1** | BOGO | CU, GS25, 7-Eleven, emart24 — **resets Nov 1!** |
...
## 🛍️ Trip-Window Events (Oct 31 – Nov 22)
...
1. **Buying alcohol** (age check) — or just skip the soju.
2. **Immediate Tax Refund at hypermarkets** (Lotte Mart / E-Mart, spend ≥₩15,000, save ~6–7%).
3. **Airline boarding-pass discounts** (name match) & **airport lounges** (card + boarding pass).

Everything else — restaurants, cafes, kiosks, markets, delivery — **your passport stays in your pocket.**
