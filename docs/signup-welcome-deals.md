# 🎁 Welcome & First-Order Deals (New-Member Freebies)

Freebies and discount coupons you get just for joining a brand's channel or placing a first order.  
...
## 🥇 Section 1: Top Tourist-Usable Welcome Deals (No ARC • No ID Check)

### 1. KakaoTalk Plus Friends (`카카오톡 채널`) — Instant Brand Welcome Coupons
Instead of downloading native Korean apps that block US phone numbers with `본인인증`, install **KakaoTalk** on your US phone number and add official brand channels as friends (`채널 추가`):
- **Burger King Korea (`@버거킹`):** Instant combo upgrade coupons, ₩1,000–₩3,000 off Whopper sets, and seasonal new-menu welcome coupons.
...
### 3. Shuttle Delivery — Foreigner-Built App + Discounted Klook E-Gift Vouchers
...
- South Korea's #1 food delivery app launched native **English, Chinese, and Japanese UI** on February 4, 2026.
- **Guest Checkout (`비회원 주문`):** You do not need a verified Korean account or ARC to order food to your hotel! Select Guest Checkout and pay using international credit cards, Apple Pay, Alipay+, or WeChat Pay.
...
## 📱 Section 2: Resident-Only Welcome Deals (`본인인증` Required — Skip as US Tourist)

The popular welcome sign-up deals below require **`본인인증` (Korean mobile carrier identity verification)** during registration. 

> **Why list them here?** To save you time! US citizens on standard tourist eSIMs cannot complete `본인인증`. Ignore these native app welcome coupons:

### Outback Boomerang Membership (`📱 본인인증` Required)
- **What it offers residents:** ₩10,000 off coupon issued the day after joining (min. ₩70,000 order), wine 2-for-₩9,000, and 10% discount or 2% points on every visit.
- **Why US Tourists should skip:** Native app registration requires `본인인증` against an ARC.
- 🟢 [Official terms](https://www.outback.co.kr/benefit/membershipBenefit.do?menuIdx=302)

### Starbucks Korea — First-Purchase Welcome Coupon (`📱 본인인증` Required)
- **What it offers residents:** Register a Starbucks Card in the KR app, make one purchase → free Tall Caffè Americano coupon next day.
- **Why US Tourists should skip:** Starbucks Korea Rewards is independent from US Starbucks and requires `본인인증` to register an account.
- 🟢 [Official terms](https://www.starbucks.co.kr/msr/msreward/level_benefit.do)

### KFC Korea App — New-Member Coupon Pack (`📱 본인인증` Required)
- **What it offers residents:** Store visit ₩1,000 Zinger sandwich, ₩5,000 delivery discount, free Butter Biscuit via Zinger Bell order.
- **Why US Tourists should skip:** Native KFC KR app requires `본인인증`. *(Use `@KFC코리아` on KakaoTalk instead for instant coupons!)*
- 🟢 [Official terms](https://www.kfckorea.com/service/membership)

---

## 🧾 First-Time Ordering & Welcome Tips for Your Trip

- **Use KakaoTalk Channels First:** Before walking into a burger or chicken joint, check your KakaoTalk chat rooms for new barcode coupons.
- **Stack Shuttle Deals:** Buy discounted Shuttle e-gift vouchers on Klook + use first-order referral promo codes for maximum delivery savings.
- **No Tipping in Korea:** Neither restaurants nor delivery drivers expect or accept tips. Your menu price or checkout total is exactly what you pay.
