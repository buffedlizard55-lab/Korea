...
> **Last verified: 2026-08-19** · **Assumption:** “chaenon” means **Cheonan (`천안`)**. If you meant Chuncheon (`춘천`) or another city, say so before using the Cheonan results.
...
| **2026 Seoul Autumn Festival** | Official Sep 19–Nov 29 calendar overlapping the trip | 📅 204 events; individual entries can be free or ticketed. `SEOUL-AUTUMN-FEST` [SMG release](https://english.seoul.go.kr/the-fun-seoul-seoul-to-become-global-cultural-hub-hosting-festivals-all-year-round/) |
...
| **Free Busan museum cluster** | Indoor, no-entry-fee alternative to paid attractions | ✅ Bokcheon Museum, Busan Marine Natural History Museum, and National Maritime Museum permanent exhibitions are free. ⚠️ **Busan Museum of Art's main building is closed for renovation** (autumn 2026 reopening announced — verify); only its free Lee Ufan Space is open. Check closures and special/4D paid exhibits. [Verified details below](#busan-free-culture-cluster) |
...
| --- | --- | --- |
| **Busan Museum of Art** | Haeundae / APEC-ro | ⚠️ **Main building CLOSED for renovation** (since Dec 2024); the museum announced an **autumn 2026 reopening**, which may or may not fall before this trip — verify first. Only **이우환공간 / Lee Ufan Space** is open (Tue–Sun 10:00–18:00, last entry 17:30) and it is **free**. Closed Mondays and Jan 1. [부산시립미술관 official](https://art.busan.go.kr/index.nm?menuCd=1) |
...
| **UN Peace Memorial Hall** | Nam-gu hill opposite UN cemetery | Official visitor page: admission and parking free; 10:00–18:00 last entry 17:30; closed Mondays and Seollal/Chuseok eve and day. Different site from UNMCK. [UNPM](http://www.unpm.or.kr/un2022/sub.php?MenuID=8) `BUSAN-UNPM` |
| **Citizens Park History Hall** | Busanjin / Citizens Park | Official city home: free; 09:00–18:00 Tue–Sun; closed Mondays and Jan 1. [시민공원 역사관](https://www.busan.go.kr/citizenpark/index) `BUSAN-CITIZEN-HIST` |
| **Dongnae Eupseong History Hall / Imjin War Hall** | Dongnae / Suan Station | Official district pages: both free; History Hall 09:00–18:00 next to Bokcheon; Imjin hall 10:00–19:00 inside Suan Station B1 closed Mondays. `BUSAN-DONGNAE-HALL` `BUSAN-IMJIN` |
| **National Fisheries Science Museum** | Gijang | Official page: admission and parking free; 09:00–18:00 last entry 17:30. Farther coastal stop. [국립수산과학관](https://www.fsm.go.kr/kr/?pCode=interGuide) `BUSAN-FSM` |
...
| **National Science Museum** | Big free base attraction near Expo/Yuseong; useful before paying for any add-on | ✅ Permanent halls, botanical garden, outdoor exhibits and children’s museum are free; planetarium/other listed exhibits are paid. ⚠️ The page’s “last Wednesday Culture Day” note may be stale after the Apr 2026 weekly-Wednesday expansion — confirm on the museum page. [Official visitor terms](https://www.science.go.kr/eps/cntnts/671/moveCntnts.do) |
