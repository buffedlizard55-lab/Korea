...
- Saturation check — `BUSAN-SEOKBULSA`, `BUSAN-BEOMEOSA-MUSEUM` (further 50-count not filled without repeating parks or using expired/out-of-city coupons)
- Fifth KTO free-admission sweep — 50 Fees: Free Hangang/temple/plaza/trail records (`SEOUL-MANGWON-HANGANG` through `SEOUL-CHEONGGYE-STREAM`)
- Fourth KTO free-admission sweep — `SEOUL-SEOULLO-7017` through `BUSAN-DALMAJI` (20 Fees: Free destination pages; cable/tower/prison museum excluded)
- City-tour bus partner discounts — `SEOUL-CITYBUS-SHILLA-DF`, `SEOUL-CITYBUS-LUGGAGELESS`, `SEOUL-CITYBUS-MOMSTOUCH-NAMSAN`, `SEOUL-CITYBUS-BABYSHARK`, `SEOUL-CITYBUS-STARFIELD-25`, `SEOUL-CITYBUS-STARFIELD-GIFT`, `SEOUL-CITYBUS-8SECONDS`, `SEOUL-CITYBUS-RAINREPORT`, `SEOUL-CITYBUS-YESEYESEE`, `SEOUL-CITYBUS-OFFBEAUTY`, `SEOUL-CITYBUS-MLB`, `SEOUL-CITYBUS-OWLS`, `SEOUL-CITYBUS-GWANHO`, `SEOUL-CITYBUS-GANGA`, `SEOUL-CITYBUS-ZAMSHH`, `SEOUL-CITYBUS-HANSANG`, `SEOUL-CITYBUS-LUMIERES`, `BUSAN-CITYTOUR-SEALIFE`, `BUSAN-CITYTOUR-XTHESKY`, `BUSAN-CITYTOUR-ARTE-MUSEUM`, `BUSAN-CITYTOUR-BOKSOONDOGA`, `BUSAN-CITYTOUR-RYAN`, `BUSAN-CITYTOUR-KIDZANIA`, `BUSAN-CITYTOUR-RYUS`, `BUSAN-CITYTOUR-KPOP`, `BUSAN-CITYTOUR-COFFEEVOICE`, `BUSAN-CITYTOUR-CASABUSANO` (all need a same-day paid boarding ticket and are non-combinable)
